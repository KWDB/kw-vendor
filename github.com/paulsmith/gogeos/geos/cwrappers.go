...
var FunctionLoadStatus uint32

var (
	// Load functions in geos library with dlsym
	geosLib = C.initGEOSLibrary()
	// Required for the thread-safe GEOS C API (the "*_r" functions).
	handle = C.gogeos_initGEOS(&FunctionLoadStatus)
...
func Version() string {
	return C.GoString(C.loadGEOSVersion(&FunctionLoadStatus))
}
...
func cGEOSversion() *C.char {
	return C.loadGEOSVersion(&FunctionLoadStatus)
}
...
func cGEOSBuffer(g1 *C.GEOSGeometry, width C.double, quadsegs C.int) *C.GEOSGeometry {
	handlemu.Lock()
	defer handlemu.Unlock()
	return C.call_fp_GEOSBuffer_r_func(handle, g1, width, quadsegs, &FunctionLoadStatus)
}
...
func cGEOSGeom_destroy(g *C.GEOSGeometry) {
	handlemu.Lock()
	defer handlemu.Unlock()
	C.call_fp_GEOSGeom_destroy_r_func(handle, g, &FunctionLoadStatus)
}
...
func cGEOSTouches(g1 *C.GEOSGeometry, g2 *C.GEOSGeometry) C.char {
	handlemu.Lock()
	defer handlemu.Unlock()
	return C.call_fp_GEOSTouches_r_func(handle, g1, g2, &FunctionLoadStatus)
}

func cGEOSIntersects(g1 *C.GEOSGeometry, g2 *C.GEOSGeometry) C.char {
	handlemu.Lock()
	defer handlemu.Unlock()
	return C.call_fp_GEOSIntersects_r_func(handle, g1, g2, &FunctionLoadStatus)
}
...
func cGEOSWithin(g1 *C.GEOSGeometry, g2 *C.GEOSGeometry) C.char {
	handlemu.Lock()
	defer handlemu.Unlock()
	return C.call_fp_GEOSWithin_r_func(handle, g1, g2, &FunctionLoadStatus)
}

func cGEOSContains(g1 *C.GEOSGeometry, g2 *C.GEOSGeometry) C.char {
	handlemu.Lock()
	defer handlemu.Unlock()
	return C.call_fp_GEOSContains_r_func(handle, g1, g2, &FunctionLoadStatus)
}
...
func cGEOSEquals(g1 *C.GEOSGeometry, g2 *C.GEOSGeometry) C.char {
	handlemu.Lock()
	defer handlemu.Unlock()
	return C.call_fp_GEOSEquals_r_func(handle, g1, g2, &FunctionLoadStatus)
}
...
func cGEOSCovers(g1 *C.GEOSGeometry, g2 *C.GEOSGeometry) C.char {
	handlemu.Lock()
	defer handlemu.Unlock()
	return C.call_fp_GEOSCovers_r_func(handle, g1, g2, &FunctionLoadStatus)
}
...
func cGEOSArea(g1 *C.GEOSGeometry, area *C.double) C.int {
	handlemu.Lock()
	defer handlemu.Unlock()
	return C.call_fp_GEOSArea_r_func(handle, g1, area, &FunctionLoadStatus)
}
...
func cGEOSDistance(g1 *C.GEOSGeometry, g2 *C.GEOSGeometry, dist *C.double) C.int {
	handlemu.Lock()
	defer handlemu.Unlock()
	return C.call_fp_GEOSDistance_r_func(handle, g1, g2, dist, &FunctionLoadStatus)
}
...
func cGEOSWKTReader_create() *C.GEOSWKTReader {
	handlemu.Lock()
	defer handlemu.Unlock()
	return C.call_fp_createGEOSWKTReader(handle, &FunctionLoadStatus)
}

func cGEOSWKTReader_destroy(reader *C.GEOSWKTReader) {
	handlemu.Lock()
	defer handlemu.Unlock()
	C.call_fp_GEOSWKTReader_destroy_r_func(handle, reader, &FunctionLoadStatus)
}

func cGEOSWKTReader_read(reader *C.GEOSWKTReader, wkt *C.char) *C.GEOSGeometry {
	handlemu.Lock()
	defer handlemu.Unlock()
	return C.call_fp_GEOSWKTReader_read_r(handle, reader, wkt, &FunctionLoadStatus)
}

func cGEOSWKTWriter_create() *C.GEOSWKTWriter {
	handlemu.Lock()
	defer handlemu.Unlock()
	return C.call_fp_GEOSWKTWriter_create_r_func(handle, &FunctionLoadStatus)
}

func cGEOSWKTWriter_destroy(writer *C.GEOSWKTWriter) {
	handlemu.Lock()
	defer handlemu.Unlock()
	C.call_fp_GEOSWKTWriter_destroy_r_func(handle, writer, &FunctionLoadStatus)
}

func cGEOSWKTWriter_write(reader *C.GEOSWKTWriter, g *C.GEOSGeometry) *C.char {
	handlemu.Lock()
	defer handlemu.Unlock()
	return C.call_fp_GEOSWKTWriter_write_r_func(handle, reader, g, &FunctionLoadStatus)
}

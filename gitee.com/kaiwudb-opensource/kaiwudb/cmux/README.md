# cmux: Connection Mux [![Build Status](https://travis-ci.org/kwbasedb/cmux.svg?branch=master)](https://travis-ci.org/kwbasedb/cmux) [![GoDoc](https://godoc.org/gitee.com/kaiwudb-opensource/kaiwudb/cmux?status.svg)](https://godoc.org/gitee.com/kaiwudb-opensource/kaiwudb/cmux)
...
There are [more examples on GoDoc](https://godoc.org/gitee.com/kaiwudb-opensource/kaiwudb/cmux#pkg-examples).
...
limitation. See https://gitee.com/kaiwudb-opensource/kaiwudb/kwbase/commit/83caba2 for an
...
See [CONTRIBUTORS](https://gitee.com/kaiwudb-opensource/kaiwudb/cmux/blob/master/CONTRIBUTORS)
for the CMux Authors. Code is released under
[the Apache 2 license](https://gitee.com/kaiwudb-opensource/kaiwudb/cmux/blob/master/LICENSE).

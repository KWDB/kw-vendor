...
func (p *printer) internalError(msg ...interface{}) {
	if debug {
		...
		fmt.Println(msg...)
		panic("gitee.com/kwbasedb/gostdlib/go/printer")
	}
}
...
func (p *printer) print(args ...interface{}) {
	for _, arg := range args {
		...
		default:
			...
			panic("gitee.com/kwbasedb/gostdlib/go/printer type")
		}
		// data != ""
...
unsupported:
	return fmt.Errorf("gitee.com/kwbasedb/gostdlib/go/printer: unsupported node type %T", node)
}
...
// use format.Node (package gitee.com/kwbasedb/gostdlib/go/format) for output that matches gofmt.
//

# cmux: Connection Mux [![Build Status](https://travis-ci.org/kwbasedb/cmux.svg?branch=master)](https://travis-ci.org/kwbasedb/cmux) [![GoDoc](https://godoc.org/github.com/cockroachdb/cmux?status.svg)](https://godoc.org/github.com/kwbasedb/cmux)

...
import (
	...
	"gitee.com/kaiwudb-opensource/kaiwudb/pebble/internal/manifest"
	...
	"gitee.com/kaiwudb-opensource/kaiwudb/pebble/sstable"
		...
		if n := len(ve.NewFiles); n > 1 {
			...
			if writerMeta.SmallestRange.UserKey != nil {
				...
				if c == 0 && prevMeta.Largest.SeqNum() <= writerMeta.SmallestRange.SeqNum() {
					...
					// https://gitee.com/kaiwudb-opensource/kaiwudb/pebble/pull/479#pullrequestreview-340600654

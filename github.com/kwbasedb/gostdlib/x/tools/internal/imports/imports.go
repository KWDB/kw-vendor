...
// Package imports implements a Go pretty-printer (like package "github.com/kwbasedb/gostdlib/go/format")
...
import (
	...
	"bytes"
	"fmt"
	"github.com/kwbasedb/gostdlib/go/format"
	"github.com/kwbasedb/gostdlib/go/printer"
	"go/ast"
	"go/build"
	"go/parser"
	"go/token"
	...
	"github.com/kwbasedb/gostdlib/x/tools/go/ast/astutil"
)

// Options is github.com/kwbasedb/gostdlib/x/tools/imports.Options with extra internal-only options.
type Options struct {
...
// Process implements github.com/kwbasedb/gostdlib/x/tools/imports.Process with explicit context in env.

...
// Package imports implements a Go pretty-printer (like package "gitee.com/kaiwudb-opensource/kaiwudb/gostdlib/go/format")
...
import (
	...
	"bytes"
	"fmt"
	"gitee.com/kaiwudb-opensource/kaiwudb/gostdlib/go/format"
	"gitee.com/kaiwudb-opensource/kaiwudb/gostdlib/go/printer"
	"go/ast"
	"go/build"
	"go/parser"
	"go/token"
	...
	"gitee.com/kaiwudb-opensource/kaiwudb/gostdlib/x/tools/go/ast/astutil"
)

// Options is gitee.com/kaiwudb-opensource/kaiwudb/gostdlib/x/tools/imports.Options with extra internal-only options.
type Options struct {
...
// Process implements gitee.com/kaiwudb-opensource/kaiwudb/gostdlib/x/tools/imports.Process with explicit context in env.

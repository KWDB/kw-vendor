# kwbasedb/errors: Go errors with network portability
...
See also [the design RFC](https://gitee.com/kaiwudb-opensource/kaiwudb/kwbase/blob/master/docs/RFCS/20190318_error_handling.md).

[![Build Status](https://travis-ci.org/kwbasedb/errors.svg?branch=master)](https://travis-ci.org/kwbasedb/errors)
...
| Feature                                                                                               | Go's <1.13 `errors` | `github.com/pkg/errors` | Go 1.13 `errors`/`xerrors` | `kwbasedb/errors` |
|-------------------------------------------------------------------------------------------------------|---------------------|-------------------------|----------------------------|----------------------|
...
| wrappers to attach [`logtags`](https://gitee.com/kaiwudb-opensource/kaiwudb/logtags) details from `context.Context` |                     |                         |                            | ✔                    |
...
- `WithContextTags(error, context.Context) error`: annotate an error with the k/v pairs attached to a `context.Context` instance with the [`logtags`](https://gitee.com/kaiwudb-opensource/kaiwudb/logtags) package.
...
`kwbasedb/errors` already does a bunch of encoding/decoding work on

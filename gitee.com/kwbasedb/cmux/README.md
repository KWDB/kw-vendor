# cmux: Connection Mux [![Build Status](https://travis-ci.org/kwbasedb/cmux.svg?branch=master)](https://travis-ci.org/kwbasedb/cmux) [![GoDoc](https://godoc.org/gitee.com/kwbasedb/cmux?status.svg)](https://godoc.org/gitee.com/kwbasedb/cmux)
...
There are [more examples on GoDoc](https://godoc.org/gitee.com/kwbasedb/cmux#pkg-examples).
...
limitation. See https://gitee.com/kwbasedb/kwbase/commit/83caba2 for an
...
See [CONTRIBUTORS](https://gitee.com/kwbasedb/cmux/blob/master/CONTRIBUTORS)
for the CMux Authors. Code is released under
[the Apache 2 license](https://gitee.com/kwbasedb/cmux/blob/master/LICENSE).

# cmux: Connection Mux [![Build Status](https://travis-ci.org/kwbasedb/cmux.svg?branch=master)](https://travis-ci.org/kwbasedb/cmux) [![GoDoc](https://godoc.org/github.com/kwbasedb/cmux?status.svg)](https://godoc.org/github.com/kwbasedb/cmux)
...
There are [more examples on GoDoc](https://godoc.org/github.com/kwbasedb/cmux#pkg-examples).
...
limitation. See https://github.com/kwbasedb/kwbase/commit/83caba2 for an
...
See [CONTRIBUTORS](https://github.com/kwbasedb/cmux/blob/master/CONTRIBUTORS)
for the CMux Authors. Code is released under
[the Apache 2 license](https://github.com/kwbasedb/cmux/blob/master/LICENSE).

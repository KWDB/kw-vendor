...
import (
	...
	"gitee.com/kaiwudb-opensource/kaiwudb/gostdlib/x/tools/internal/imports"
)
...
func usage() {
	...
	fmt.Fprintln(os.Stderr, "This goimports is from gitee.com/kaiwudb-opensource/kaiwudb/gostdlib.")
	os.Exit(2)
}

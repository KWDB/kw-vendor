...
// Package imports implements a Go pretty-printer (like package "gitee.com/kwbasedb/gostdlib/go/format")
...
import (
	...
	"bytes"
	"fmt"
	"gitee.com/kwbasedb/gostdlib/go/format"
	"gitee.com/kwbasedb/gostdlib/go/printer"
	"go/ast"
	"go/build"
	"go/parser"
	"go/token"
	...
	"gitee.com/kwbasedb/gostdlib/x/tools/go/ast/astutil"
)

// Options is gitee.com/kwbasedb/gostdlib/x/tools/imports.Options with extra internal-only options.
type Options struct {
...
// Process implements gitee.com/kwbasedb/gostdlib/x/tools/imports.Process with explicit context in env.

...
func ingestLink(
	...
	for i := range paths {
		...
		if _, ok := opts.FS.(*vfs.MemFS); ok && opts.DebugCheck != nil {
			...
			// occurs. See https://gitee.com/kaiwudb-opensource/kaiwudb/pebble/issues/495.
...
// https://gitee.com/kaiwudb-opensource/kaiwudb/pebble/issues/25 for an idea for how to fix
// this hiccup.

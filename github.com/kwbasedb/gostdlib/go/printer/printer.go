...
func (p *printer) internalError(msg ...interface{}) {
	if debug {
		...
		fmt.Println(msg...)
		panic("github.com/kwbasedb/gostdlib/go/printer")
	}
}
...
func (p *printer) print(args ...interface{}) {
	for _, arg := range args {
		...
		default:
			...
			panic("github.com/kwbasedb/gostdlib/go/printer type")
		}
		// data != ""
...
unsupported:
	return fmt.Errorf("github.com/kwbasedb/gostdlib/go/printer: unsupported node type %T", node)
}
...
// use format.Node (package github.com/kwbasedb/gostdlib/go/format) for output that matches gofmt.
//
